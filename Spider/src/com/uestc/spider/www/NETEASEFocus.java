...
public class NETEASEFocus implements NETEASE{
	...
	public void getNETEASEFocusNews(){
		...
		String[] newsSourceLabel =new String[]{"class","ep-time-soure cDGray","网易新闻-深度新闻"}; //（3个参数）新闻来源 同新闻时间"class","ep-time-soure cDGray" 
...
//          e.printStackTrace();
		...
		//保存深度新闻主题links
		Queue<String> focusNewsTheme = new LinkedList<String>();
		focusNewsTheme = findThemeLinks(theme,newsThemeLinksReg);
//		System.out.println(guoNeiNewsTheme);
		
		//获取深度新闻内容links
		Queue<String>focusNewsContent = new LinkedList<String>();
		focusNewsContent = findContentLinks(focusNewsTheme,newsContentLinksReg);
//		System.out.println(guoNeiNewsContent);
		//获取每个新闻网页的html
		int i = 0;
		while(!focusNewsContent.isEmpty()){
			String url = focusNewsContent.poll();
...
//			return timeBuf;
	...
	public static void main(String[] args){
		NETEASEFocus test = new NETEASEFocus();
		test.getNETEASEFocusNews();
	}
}
